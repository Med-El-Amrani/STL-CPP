...
#include "stl_custom/containers/map.hpp" // this project's map implementation (compile with -Iinclude)
...
// The tests below are written against the historical `ft::` namespace.
// Map it onto this project's `stl_custom` namespace; pair/make_pair and
// reverse_iterator are not reimplemented here, so they come from the STL.
namespace ft {
using stl_custom::map;
using std::make_pair;
using std::pair;
